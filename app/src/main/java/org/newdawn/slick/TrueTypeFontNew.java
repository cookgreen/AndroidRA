...
import org.newdawn.slick.util.BufferedImageNewUtil;
...
public class TrueTypeFontNew implements Font {
    ...
    private net.windward.android.awt.Font font;
     ...
     */
    public TrueTypeFontNew(net.windward.android.awt.Font font, boolean antiAlias, char[] additionalChars) {
     ...
     *            Whether or not to apply AntiAliasing to the cached font
     */
    public TrueTypeFontNew(net.windward.android.awt.Font font, boolean antiAlias) {
    ...
    private BufferedImage getFontImage(char ch) {
        ...
        gt.setColor(net.windward.android.awt.Color.white);
        int charx = 0;
        int chary = 0;
    ...
    private void createSet( char[] customCharsArray ) {
        ...
        try {
            ...
            g.setColor(new net.windward.android.awt.Color(255,255,255,1));
            ...
            fontTexture = BufferedImageNewUtil
